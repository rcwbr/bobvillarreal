...
for gallery_counter in 0...galleries_info.length
  ...
  for defaults_counter in 1...GALLERY_DEFAULTS.keys.length
    if galleries_info[gallery_counter][GALLERY_DEFAULTS.keys[defaults_counter]] == nil
      galleries_info[gallery_counter][GALLERY_DEFAULTS.keys[defaults_counter]] = GALLERY_DEFAULTS[GALLERY_DEFAULTS.keys[defaults_counter]]
    end
  end
  ...
  for i in 0...galleries_info[gallery_counter]["image_filename_matrix"].length
    ...
    for j in 0...galleries_info[gallery_counter]["image_filename_matrix"][i].length
      print "#{galleries_info[gallery_counter]["image_filename_matrix"][i][j]} " if IKARUS_VERBOSE
    end
